        ...
        <div className="glass-panel border border-outline-variant/15 p-4 space-y-3">
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center py-8 text-on-surface-variant">
              ...
              <div className="text-[10px] uppercase tracking-wider opacity-60">Contract not deployed — history will appear after deployment</div>
            </div>
          ) : swaps.length === 0 ? (
            /* Empty state matching Direct Swap */
            <div className="flex flex-col items-center justify-center py-8 text-on-surface-variant">
              <Ghost className="w-12 h-12 mb-3 opacity-20" />
              <div className="text-sm font-headline uppercase tracking-widest text-white mb-1">No Swaps Found</div>
            ...
            <>
              {swaps.slice(0, 20).map((swap, idx) => {
                ...
                return (
                  <div key={idx} className="border-b border-outline-variant/10 pb-2 last:border-0 last:pb-0">
