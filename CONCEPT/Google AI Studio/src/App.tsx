        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
          ...
          <div className="bg-surface-container-high p-6 flex flex-col items-end border-r-4 border-primary neon-border">
            ...
            <button 
              ...
              className="bg-primary text-on-primary px-6 py-2 font-headline font-bold uppercase tracking-widest text-sm hover:bg-white transition-colors active:scale-95"
            >
              + Create Pool
            </button>
          </div>
        ...
        <div className="md:col-span-8 bg-surface-container-low p-8 group relative overflow-hidden transition-all duration-300 hover:bg-surface-container-high hover:-translate-y-1 hover:border-primary/30 border border-outline-variant/15">
          ...
          <div className="flex gap-4 relative z-10">
            <button 
              ...
              className="flex-1 bg-primary text-on-primary h-16 font-headline font-black tracking-widest uppercase transition-all duration-150 hover:bg-white active:scale-95 flex items-center justify-center gap-3"
            >
        ...
        <div className="md:col-span-4 bg-surface-container-low p-8 relative overflow-hidden transition-all duration-300 hover:bg-surface-container-high hover:-translate-y-1 hover:border-primary/30 border border-outline-variant/15">
          <div className="flex flex-col h-full justify-between">
            ...
            <button 
              ...
              className="w-full bg-primary text-on-primary py-5 font-headline font-black tracking-widest uppercase transition-all duration-150 hover:bg-white active:scale-95"
            >
              FEED THE POOL
            </button>
          </div>
        ...
        <div className="md:col-span-4 bg-surface-container-low p-8 relative overflow-hidden transition-all duration-300 hover:bg-surface-container-high hover:-translate-y-1 hover:border-primary/30 border border-outline-variant/15">
          <div className="flex flex-col h-full justify-between">
            <div>
              ...
              <h3 className="font-headline text-3xl font-black text-white uppercase tracking-tighter mb-2">OMNOM / WETH</h3>
            ...
            <button 
              onClick={() => setManagePool({ id: 'OMNOM/WETH', t1: 'OMNOM', t2: 'WETH' })}
              className="w-full bg-primary text-on-primary py-5 font-headline font-black tracking-widest uppercase transition-all duration-150 hover:bg-white active:scale-95"
            >
              FEED THE POOL
            </button>
      ...
      <div className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6 pt-8">
        ...
        <div className="flex flex-col items-end gap-2">
          ...
          <div className="flex gap-4">
            <div className="p-4 bg-surface-container-low border-l-4 border-secondary text-right">
            ...
            <div className="p-4 bg-surface-container-low border-l-4 border-primary text-right">
        ...
        <div className="md:col-span-4 bg-surface-container-high p-8 flex flex-col justify-between border border-outline-variant/15">
          <div>
            ...
            <div className="space-y-4">
              <button className="w-full group flex items-center justify-between p-4 bg-primary text-on-primary hover:bg-white transition-all shadow-[0_0_30px_rgba(255,215,0,0.2)]">
              ...
              <button 
                ...
                className={`w-full font-headline font-black text-xl py-5 uppercase tracking-tighter transition-all relative overflow-hidden ${
                  isDisabled 
                    ...
                    : 'bg-primary text-on-primary shadow-[0_0_30px_rgba(255,215,0,0.3)] hover:shadow-[0_0_50px_rgba(255,215,0,0.5)] active:scale-[0.98]'
                }`}
              >
              ...
              <>
                ...
                <div className="flex gap-4">
                  ...
                  <button 
                    ...
                    className="flex-1 py-3 font-headline font-black uppercase tracking-widest bg-primary text-on-primary hover:bg-white transition-colors shadow-[0_0_20px_rgba(255,215,0,0.2)]"
                  >
                    Confirm
                  </button>
                </div>
            ...
            <div className="space-y-4">
              ...
              <div className="pt-4">
                <button 
                  ...
                  className="w-full bg-primary text-on-primary font-headline font-black text-xl py-5 uppercase tracking-tighter shadow-[0_0_30px_rgba(255,215,0,0.3)] hover:shadow-[0_0_50px_rgba(255,215,0,0.5)] active:scale-[0.98] transition-all"
                >
                  AUTHORIZE & FEED
                </button>
              </div>
      ...
      <div className="bg-surface-container-low border border-primary/30 w-full max-w-lg shadow-[0_0_50px_rgba(255,215,0,0.15)] flex flex-col">
        ...
        <div className="p-6 space-y-6">
          ...
          <button 
            ...
            className={`w-full font-headline font-black text-xl py-5 uppercase tracking-tighter transition-all ${(!amount1 || !amount2) ? 'bg-surface-container-highest text-on-surface-variant cursor-not-allowed border border-outline-variant/30' : 'bg-primary text-on-primary shadow-[0_0_30px_rgba(255,215,0,0.3)] hover:shadow-[0_0_50px_rgba(255,215,0,0.5)] active:scale-[0.98]'}`}
          >
            INITIALIZE POOL
          </button>
        </div>
